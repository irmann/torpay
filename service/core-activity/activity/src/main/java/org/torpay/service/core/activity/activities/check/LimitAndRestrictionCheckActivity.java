...
public class LimitAndRestrictionCheckActivity extends CoreActivityBase
		implements CoreActivity {

	static final Logger LOG = LoggerFactory
			.getLogger(LimitAndRestrictionCheckActivity.class);
	...
	public String getName() {
		return CoreActivityNames.LIMIT_AND_RESTRICTION_CHECK;
	}
