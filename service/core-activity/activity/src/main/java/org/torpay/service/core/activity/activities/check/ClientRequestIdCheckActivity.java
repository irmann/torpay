...
public class ClientRequestIdCheckActivity extends CoreActivityBase
		implements CoreActivity {

	static final Logger LOG = LoggerFactory
			.getLogger(ClientRequestIdCheckActivity.class);
	...
	public String getName() {
		return CoreActivityNames.CLIENT_REQUIST_ID_CHECK;
	}
