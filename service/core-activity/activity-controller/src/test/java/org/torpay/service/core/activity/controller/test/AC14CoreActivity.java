...
public class AC14CoreActivity extends CoreActivityBase implements CoreActivity {
	...
	public String getName() {
		return CoreActivityConstantTest.AC_14;
	}
	...
	public String getBlackList() {
		return "provider1.action1,provider2.action2,provider3.*";
	}
