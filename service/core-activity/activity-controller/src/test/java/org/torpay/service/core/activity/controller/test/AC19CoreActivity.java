...
public class AC19CoreActivity extends CoreActivityBase implements CoreActivity {
	public static Boolean VISITED = false;

	public void executeChild(ActionRequest actionRequest)
			throws ActivityControllException {
		throw new ActivityControllException(ErrorCodes.TECHNICAL_ERROR, "test exception", null);

	}

	public String getName() {
		return CoreActivityConstantTest.AC_19;
	}
	...
	public ActivityErrorHandler getActivityErrorHandler() {
		return new ActivityErrorHandlerDefaultImpl();
	}
}
